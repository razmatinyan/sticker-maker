	...
	<div class="max-w-2xl space-y-5">
		...
		<div class="stagger-item" style="--stagger-index: 0">
			...
			<p class="text-muted-foreground text-sm mt-1">
				Connect your Telegram bot to push sticker packs directly to
				Telegram.
			</p>
		</div>
		...
		<template v-else>
				...
				<div class="flex items-center gap-3">
					...
					<div>
						...
						<p class="text-xs text-muted-foreground">
							Bot token ending in
							...{{ profile.telegram_bot_token.slice(-8) }}
						</p>
					</div>
					<div class="ml-auto">
						<Badge
			...
			<!-- Setup form -->
			<div v-else class="glass-surface p-5 space-y-5 stagger-item" style="--stagger-index: 1">
				...
				<div class="space-y-3">
					...
					<div class="space-y-2">
						...
						>
							<div
								class="w-5 h-5 rounded-full text-xs flex items-center justify-center shrink-0 mt-0.5 text-white font-semibold"
				...
				<div class="space-y-4">
					...
					<div
						v-if="success"
						class="text-xs text-green-400 bg-green-400/10 border border-green-400/20 rounded-lg px-3 py-2"
					>
						{{ success }}
					</div>
